				...
				<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<div class="row">
							<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
								...
								{!!Form::text('name',$news->name,['class'=>'form-control','placeholder'=>'Ingrese el nombre de la noticia', 'style'=>'-webkit-border-radius: 8px;-moz-border-radius: 8px;border-radius: 8px;'])!!}
							</div>
							<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
								{!!Form::label('Url de la noticia')!!}
								{!!Form::text('url',$news->url,['class'=>'form-control','placeholder'=>'Ingrese la url de la noticia', 'style'=>'-webkit-border-radius: 8px;-moz-border-radius: 8px;border-radius: 8px;'])!!}
							</div>
							<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
								{!!Form::label('Imagen')!!}
